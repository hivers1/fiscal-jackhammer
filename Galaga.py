...
def main():
  ...
  backdrop = pygame.image.load('pic_data/bdrop.jpg')
  hero = Ship(20, 400, pygame.image.load('pic_data/hero.png'))
  h_missile = Ship(0, 480, pygame.image.load('pic_data/h_missile.png'))
  e_missile = Ship(0, 480, pygame.image.load('pic_data/e_missile.png'))
  e_missile.render()
  e_missile.y += 5
  hero.render()
  Play()
